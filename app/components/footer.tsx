...
export default function Footer() {
  return (
        <footer className="bg-primary min-h-140 max-w-[1650px] w-full overflow-hidden">
            <div className='md:border border-b-white flex flex-col md:flex-row justify-between items-center md:py-12 md:px-20 gap-3 '>
            ...
            <div className='border-t border-white md:border-none flex md:justify-between px-4 py-8 mt-2 md:py-12 md:px-20'>
